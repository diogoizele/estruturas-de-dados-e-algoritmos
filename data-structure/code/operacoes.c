...
int main()
{
    ...
    printf("\nelement %d found on %d index", 5, arr_search(arr, ARRAY_INITIAL_LENGTH, 5));
    printf("\nelement %d found on %d index", 70, arr_search(arr, ARRAY_INITIAL_LENGTH, 70));
